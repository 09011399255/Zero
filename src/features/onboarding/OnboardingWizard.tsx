...
export function OnboardingWizard({
  ...
  // Step 3 (Connect WhatsApp) now lives entirely in the shared
  // <WhatsAppConnectPanel /> — the same component powers Settings and the
  // app-wide "enter your code" modal, so there's one implementation to maintain.
    ...
    <div className="max-w-[460px] w-full mx-auto pb-16 pt-8 animate-fade-in font-sans text-xs relative">
      ...
      {onboardingStep === 3 && (
        <WhatsAppConnectPanel
          onDone={() => setOnboardingStep(4)}
          doneLabel="Continue to Staff Setup"
          onSecondary={() => setOnboardingStep(4)}
